...
{
    public partial class DeleteInProcessAccounts : System.Web.UI.Page
    {
        ...
        private void loaddata()
        {
            ...
            if (LoggedUser.USER_TYPE == UserType.Branch)
                grdPCif.DataSource = ac.GetInProcessAccountsByRole(LoggedUser.Role.Name, false);
            else
                grdPCif.DataSource = ac.GetInProcessAccountsByRole(LoggedUser.Role.Name, true);
            grdPCif.DataBind();
