...
namespace CAOP
{
    public partial class Account_Government : System.Web.UI.Page
    {
        ...
        private void SetAccountNature()
        {
            ...
            AcListAccountOpen.Items.FindByText("GOVERNMENT").Selected = true;
           ...
           // AcListAccountOpen.Items.FindByText("BUSINESS").Selected = true;
        }
        ...
        protected void CiSubmitButton_Click(object sender, EventArgs e)
        {
            ...
            a.PROVINCE = new Province() { ID = (int) ListExtensions.getSelectedValue(CiListProvince) };
        ...
        protected void Search_BusinessCIF_Click(object sender, EventArgs e)
        {
            ...
            CIF cf = new CIF(LoggedUser.USER_ID);
            SearchBusinessCif.DataSource = cf.GetCifsForGovernment(SearchBusinessCifText.Text, Status.APPROVED_BY_BRANCH_MANAGER);
            SearchBusinessCif.DataBind();
