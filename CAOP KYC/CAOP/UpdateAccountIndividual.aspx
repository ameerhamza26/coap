<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Default.Master" CodeBehind="UpdateAccountIndividual.aspx.cs" Inherits="CAOP.UpdateAccountIndividual" %>
                ...
                <div class="tab-content">
                    <div id="sectiona" class="tab-pane fade in active">
                        ...
                        <div class="form-group">
                            ...
                            <asp:Button ID="btnUpdateAc" ClientIDMode="Static" runat="server" Text="UPDATE" CssClass="btn btn-primary" ValidationGroup="AcValidationGroup" OnClick="btnUpdateAc_Click" />
                    ...
                    <div id="sectionb" class="tab-pane fade">
                        ...
                        <div class="form-group">
                            ...
                            <asp:CustomValidator ID="CustomValidatorAccountType" runat="server" Display="Dynamic" ForeColor="Red" Font-Bold="true" ValidationGroup="ApValidationGroup" ErrorMessage="---" OnServerValidate="CustomValidatorAccountType_ServerValidate" ></asp:CustomValidator>
                                    ...
                                    <ContentTemplate>
                                        <asp:GridView class="table" ShowHeaderWhenEmpty="true" Enabled="false" Visible="false" ID="GridViewAccountCifs" runat="server" AutoGenerateColumns="false" OnRowDataBound="GridViewAccountCifs_RowDataBound" OnDataBound="GridViewAccountCifs_DataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="CUSTOMER IDENTITY">
                                                    <ItemTemplate>
                        ...
                        <asp:UpdatePanel runat="server" ID="updatePanel_Applications" UpdateMode="Conditional" ClientIDMode="AutoID" ChildrenAsTriggers="true">
                            ...
                            <ContentTemplate>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="AdListCountry" ClientIDMode="Static" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="AdListCountry_SelectedIndexChanged"></asp:DropDownList>
                            ...
                            <ContentTemplate>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:RadioButton ID="WhtTransactionRadio2" Text="No" Checked="true" GroupName="WhtTransactionRadioGroup" AutoPostBack="true" runat="server" OnCheckedChanged="WhtTransactionRadio1_CheckedChanged" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="lblReview">Expiry Date (If No): </label>
                             ...
                             <asp:RequiredFieldValidator InitialValue="0" Display="Dynamic" ID="RequiredFieldValidatorPurposeAccount" ControlToValidate="KnListPurposeOfAccount" Font-Bold="true" ForeColor="Red" runat="server" ValidationGroup="KnValidationGroup" ErrorMessage="Purpose of account is Required"></asp:RequiredFieldValidator>--%>
                              ...
                              <asp:RequiredFieldValidator InitialValue="0" Display="Dynamic" ID="RequiredFieldValidatorSourceFunds" ControlToValidate="KnListSourceOfFunds" Font-Bold="true" ForeColor="Red" runat="server" ValidationGroup="KnValidationGroup" ErrorMessage="Source of Funds is Required"></asp:RequiredFieldValidator>--%>
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="overflow-x: hidden; overflow-y: auto; border: 1px #808080 solid; max-height: 215px; height: auto; height: 215px">
                                        <asp:CheckBoxList ID="KnListECP" AutoPostBack="true" runat="server" RepeatColumns="2" OnSelectedIndexChanged="KnListECP_SelectedIndexChanged"></asp:CheckBoxList>
                                    </div>
                    ...
                    <div id="sectiong" class="tab-pane fade">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator Enabled="false"   Display="Dynamic" ID="RequiredFieldValidatorProfitAccNumber" ControlToValidate="CdProfitAccountNumber" Font-Bold="true" ForeColor="Red" runat="server" ValidationGroup="CdValidationGroup" ErrorMessage="Profit Account Number is Required"></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group" style="display: none">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator Enabled="false"   Display="Dynamic" ID="RequiredFieldValidatorCdCertNumber" ControlToValidate="CdCertNumber" Font-Bold="true" ForeColor="Red" runat="server" ValidationGroup="CdValidationGroup" ErrorMessage="Certificate Number is Required"></asp:RequiredFieldValidator>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="CdMarkupRate" ClientIDMode="Static" CssClass="form-control" runat="server" TextMode="Number"></asp:TextBox>
                            <asp:RequiredFieldValidator Enabled="false"   Display="Dynamic" ID="RequiredFieldValidatorCdMarkupRate" ControlToValidate="CdMarkupRate" Font-Bold="true" ForeColor="Red" runat="server" ValidationGroup="CdValidationGroup" ErrorMessage="Mark Up Rate is Required"></asp:RequiredFieldValidator>
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="CdLstPrincipalRenewal" ClientIDMode="Static" CssClass="form-control" runat="server"></asp:DropDownList>
                             <asp:RequiredFieldValidator Enabled="false" InitialValue="0"   Display="Dynamic" ID="RequiredFieldValidatorCdLstPrincipalRenewal" ControlToValidate="CdLstPrincipalRenewal" Font-Bold="true" ForeColor="Red" runat="server" ValidationGroup="CdValidationGroup" ErrorMessage="Principal Renewal Option is Required"></asp:RequiredFieldValidator>
                        </div>
