<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Default.Master" CodeBehind="UpdateAccountOffice.aspx.cs" Inherits="CAOP.UpdateAccountOffice" %>
...
<asp:Content ID="Body" ContentPlaceHolderID="Body" runat="server">
                    ...
                    <div class="modal-body">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" UpdateMode="Conditional" runat="server">
                            <ContentTemplate>
                                ...
                                <label class="lblReview">Search Office CIF:</label>
                         <asp:TextBox ID="SearchBusinessCifText"  ClientIDMode="Static" CssClass="form-control" runat="server" ></asp:TextBox>
                            ...
                            <div class="controls"> 
                            <asp:RadioButton ID="RadioButton1" Text="Name" Style="margin-right: 5px" Enabled="false" Checked="True" GroupName="SearchEntityCifGroup" runat="server" />
  ...
  <div class="modal fade" id="SearchCifWho" role="dialog">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView class="table" PagerStyle-CssClass="bs-pagination" ID="GridWhoCif" runat="server"  AutoGenerateColumns="false">
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                            <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Bind("ID") %>' Text="Select"  OnClientClick='<%# String.Format("return select_who_cif({0},\"{1}\",\"{2}\",\"{3}\",\"{4}\",\"{5}\");",Eval("ID"),Eval("FIRST_NAME"),Eval("MIDDLE_NAME"),Eval("LAST_NAME"),Eval("CNIC"),Eval("PRIMARY_DOCUMENT_TYPE")) %>'></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
        ...
        <h3>ACCOUNT OPENING FORM - OFFICE</h3>
        <hr />
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="tab-content">
                    <div id="sectiona" class="tab-pane fade in active">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="AcListPOA" ClientIDMode="Static" CssClass="form-control" runat="server"></asp:DropDownList>
                             <asp:RequiredFieldValidator Display="Dynamic" InitialValue="0" ID="RequiredFieldValidatorPOA" ValidationGroup="AcValidationGroup" runat="server" ControlToValidate="AcListPOA" ForeColor="Red" Font-Bold="true" ErrorMessage=">Purpose Of Account is Required"></asp:RequiredFieldValidator>
                        </div>
                        ...
                        <ContentTemplate>
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="AcListAccountClass" Enabled="false" AutoPostBack="true" ClientIDMode="Static" CssClass="form-control" runat="server" OnSelectedIndexChanged="AcListAccountClass_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <label class="lblReview">Account Group:</label>
                                <asp:DropDownList ID="AcListAccountGroup" Enabled="false" AutoPostBack="true" ClientIDMode="Static" CssClass="form-control" runat="server" OnSelectedIndexChanged="AcListAccountGroup_SelectedIndexChanged"></asp:DropDownList>
                            </div>

                            <div class="form-group">
                                <label class="lblReview">Account Type: *</label>
                                <asp:DropDownList ID="AcListAccountType" Enabled="false" AutoPostBack="true" ClientIDMode="Static" CssClass="form-control" runat="server" OnSelectedIndexChanged="AcListAccountType_SelectedIndexChanged"></asp:DropDownList>
                    ...
                    <div id="sectionb" class="tab-pane fade">
                        ...
                        <div class="form-group">
                             <asp:Button ID="CiSearchCifButton" style="margin-bottom: 5px; float:right" runat="server" Text="Search Office CIF" data-toggle="modal" OnClientClick="return false;" data-target="#SearchBusinessCIF" CssClass="btn btn-primary" OnClick="CiSearchCifButton_Click"/>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                 <asp:GridView class="table" ShowHeaderWhenEmpty="true"    ID="GrdBeneficial" runat="server"  AutoGenerateColumns="false">
                                        ...
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                <asp:Button runat="server" ID="Button1" Text="DELETE" OnClick="btnDelete_Click1"></asp:Button>
                                            </ItemTemplate>
                                        </asp:TemplateField>
