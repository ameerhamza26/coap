...
namespace CAOP
{
    public partial class UpdateGovernment : System.Web.UI.Page
    {
        ...
        private void SetBasicInfoOpen(int id)
        {
            ...
            if (b.GetBusiness(id))
            {
                ...
                ListExtensions.SetDropdownValue(b.GOV_TYPE, BiListGovType);
        ...
        private void SetBasicInfo()
        {
            ...
            BiListGovType.DataSource = gt.GetGovTypes();
            ...
            BiListGovType.DataValueField = "ID";
            BiListGovType.DataTextField = "Name";
            BiListGovType.DataBind();
            BiListGovType.Items.Insert(0, new ListItem("Select", "0"));


            //  BiDateOfRegistration.Text = DateTime.Now.ToString("yyyy-MM-dd");
            //   BiDateOfCommence.Text = DateTime.Now.ToString("yyyy-MM-dd");
            BiListCifType.Items.FindByText("GOVERNMENT").Selected = true;
