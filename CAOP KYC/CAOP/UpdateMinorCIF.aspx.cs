...
namespace CAOP
{
    public partial class UpdateMinorCIF : System.Web.UI.Page
    {
        ...
        private void SetBIData()
        {
            ...
            lstCifType.DataBind();
            lstCifType.Items.FindByText("MINOR").Selected = true;
        ...
        {
            // ScriptManager.RegisterStartupScript(this, GetType(), "checkDate", "checkDate();", true);
            if (Page.IsValid)
            {
        ...
        protected void CustomValidatorDate_ServerValidate(object source, ServerValidateEventArgs args)
        {
            try
            {
                ...
                //System.Diagnostics.Debug.WriteLine("new date " + newDate);
                //System.Diagnostics.Debug.WriteLine("currentDate " + currentDate);
                TimeSpan span = currentDate - newDate;
                //System.Diagnostics.Debug.WriteLine("currentdate -newdate " + (span));
                int years = (zeroTime + span).Year - 1;
                //System.Diagnostics.Debug.WriteLine("currentdate -newdate in year " + years);
                if (years <= 18)
                {
                    args.IsValid = true;
                }
                ...
                {
                    CustomValidatorDate.ErrorMessage = "Date Of Birth must be 18 Years Old or less to Current Date";
                    args.IsValid = false;
                }
            }
            catch
            {
                CustomValidatorDate.ErrorMessage = "Invalid Date";
                args.IsValid = false;
            }
