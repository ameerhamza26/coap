<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Default.Master" CodeBehind="EditUser.aspx.cs" Inherits="CAOP.UserForms.EditUser" %>
        ...
        <div class="tab-content">
            ...
            <div class="col-md-4">
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label >Email: *</label>
                    <asp:TextBox ID="txtemail" TextMode="Email" ClientIDMode="Static" CssClass="form-control" runat="server"></asp:TextBox>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label >Regions: *</label>
                    <asp:DropDownList  ID="ddlRegions" ClientIDMode="Static" CssClass="form-control" runat="server"></asp:DropDownList>
                    <asp:RequiredFieldValidator  Display="Dynamic"  ID="RequiredFieldValidatorRegions" InitialValue="0" runat="server" ForeColor="Red" Font-Bold="true" ValidationGroup="CREATE" ControlToValidate="ddlRegions" ErrorMessage="Region is Required"></asp:RequiredFieldValidator>
                </div>
                ...
                <div class="form-group">
                    <label  class="lblReview">Active/DeActive: </label>
                     <asp:DropDownList  ID="ddlAD" ClientIDMode="Static" CssClass="form-control" runat="server"></asp:DropDownList>
                </div>
                 <asp:Button ID="btnCreate" runat="server" Text="UPDATE" ValidationGroup="CREATE" CssClass="btn btn-primary" OnClick="btnCreate_Click" />
                </div>
                                </div>
