<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Default.Master" CodeBehind="AccountReport.aspx.cs" Inherits="CAOP.AccountReport" %>
...
<asp:Content ID="Body" ContentPlaceHolderID="Body" runat="server">
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="" Visible="false">
            <ItemTemplate>
                <asp:Label ID="btnAccountType" runat="server" Text='<%# Bind("ACCOUNT_MODE_DETAIL") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
