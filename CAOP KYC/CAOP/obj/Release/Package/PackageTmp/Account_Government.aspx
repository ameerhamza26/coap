<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPages/Default.Master" CodeBehind="Account_Government.aspx.cs" Inherits="CAOP.Account_Government" %>
...
<asp:Content ID="Body" ContentPlaceHolderID="Body" runat="server">
                    ...
                    <div class="modal-body">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" UpdateMode="Conditional" runat="server">
                            <ContentTemplate>
                                ...
                                <label class="lblReview">Search Data by Name:</label>
  ...
  <div class="modal fade" id="SearchCifWho" role="dialog">
        ...
        <h3>ACCOUNT OPENING FORM - Government</h3>
        <hr />
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <div class="tab-content">
                    <div id="sectiona" class="tab-pane fade in active">
                        ...
                        <asp:CheckBox runat="server" ID="AcCnicVerifiedCheck" Text="1. Is CNIC Verified? 2. Have All CIF's been Created?" />
                        <br />
                        ...
                        <ContentTemplate>
                            ...
                            <asp:DropDownList ID="AcListAccountType" ClientIDMode="Static" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="AcListAccountType_SelectedIndexChanged" runat="server"></asp:DropDownList>
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator Display="Dynamic" InitialValue="0" ID="RequiredFieldValidatorCurrency" ValidationGroup="AcValidationGroup" runat="server" ControlToValidate="AcListCurrency" ForeColor="Red" Font-Bold="true" ErrorMessage="Currency is Required"></asp:RequiredFieldValidator>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="AcInitialDeposit" ClientIDMode="Static" CssClass="form-control" runat="server"></asp:TextBox>
                    ...
                    <div id="sectionb" class="tab-pane fade">
                        ...
                        <div class="form-group">
                             <asp:Button ID="CiSearchCifButton" style="margin-bottom: 5px; float:right" runat="server" Text="Search Government CIF" data-toggle="modal" OnClientClick="return false;" data-target="#SearchBusinessCIF" CssClass="btn btn-primary" OnClick="CiSearchCifButton_Click"/>
                        ...
                        <div  class="form-group">
                            ...
                            <asp:TextBox ID="CiTxtBuilding" CssClass="form-control" runat="server"></asp:TextBox>
                         ...
                         <div  class="form-group">
                            ...
                            <asp:TextBox ID="CiTxtFloor" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                         <div  class="form-group">
                            <label class="lblReview">Address Line 3:</label>
                            <asp:TextBox ID="CiTxtStreet" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div  class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="CiTelOffice" ClientIDMode="Static" CssClass="form-control" runat="server"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="CiTelResidence" ClientIDMode="Static" CssClass="form-control" runat="server"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="CiMobileNo" ClientIDMode="Static" CssClass="form-control" runat="server"></asp:TextBox>

                        </div>

                        <div class="form-group">
                            <label class="lblReview">Fax No:</label>
                            <asp:TextBox ID="CiFaxNo" ClientIDMode="Static" CssClass="form-control" runat="server"></asp:TextBox>
                    ...
                    <div id="sectionc" class="tab-pane fade">
                        <h3>Authorized Persons</h3>
                          ...
                          <div class="form-group">
                            ...
                            <label class="lblReview">CIF No: *</label>
                            <asp:TextBox ID="AuthCustomerCif" ClientIDMode="Static" ReadOnly="true" CssClass="form-control col-md-3" runat="server"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="AuthCustomerName" ClientIDMode="Static" ReadOnly="true" CssClass="form-control" runat="server"></asp:TextBox>
                        ...
                        <div class="form-group">
                            <label class="lblReview">Customer CNIC: *</label>
                            <asp:TextBox ID="AuthCustomerCNIC" ClientIDMode="Static" ReadOnly="true" CssClass="form-control" runat="server"></asp:TextBox>
                    ...
                    <div id="sectiond" class="tab-pane fade">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator  Display="Dynamic" ID="RequiredFieldValidatorRefNo" runat="server" ForeColor="Red" Font-Bold="true" ValidationGroup="ValidationGroupWho" ControlToValidate="WhoTxtRefNo" ErrorMessage="Identity No is Required"></asp:RequiredFieldValidator>
                         </div>
                         <div class="form-group" >
                    ...
                    <div id="sectionf" class="tab-pane fade">
                        ...
                        <asp:UpdatePanel ID="UpdatePanelKnowYourCustomer" runat="server" UpdateMode="Always">
                            ...
                            <asp:DropDownList ID="KnListCustomerType" ClientIDMode="Static" CssClass="form-control" runat="server"></asp:DropDownList>
                             <asp:RequiredFieldValidator  ID="RequiredFieldValidatorKnCustomerType" ControlToValidate="KnListCustomerType" InitialValue="0" ErrorMessage="Customer Type is Required" runat="server" Display="Dynamic"  ForeColor="Red" Font-Bold="true" ValidationGroup="KnValidationGroup" ></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator  ID="RequiredFieldValidator2" ControlToValidate="KnListEducation" InitialValue="0" ErrorMessage="Education is Required" runat="server" Display="Dynamic"  ForeColor="Red" Font-Bold="true" ValidationGroup="KnValidationGroup" ></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator  ID="RequiredFieldValidatorKnSourceFund" ControlToValidate="KnListSourceOfFunds" InitialValue="0" ErrorMessage="Source of Funds is Required" runat="server" Display="Dynamic"  ForeColor="Red" Font-Bold="true" ValidationGroup="KnValidationGroup" ></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group">
                            <label class="lblReview">Description of Source:</label>
                      ...
                      <div class="control-group">
                        ...
                        <div class="form-group">
                            <label class="lblReview">Mode of Transactions</label>
                            <asp:CheckBoxList ID="KnListModeOfTransaction" runat="server"></asp:CheckBoxList>
                        </div>

                        <div class="form-group">
                            <label class="lblReview">Other Mode of Transactions:</label>
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="KnListRealBenef" ClientIDMode="Static" CssClass="form-control" runat="server"></asp:DropDownList>
                            <asp:RequiredFieldValidator  ID="RequiredFieldValidatorKnRealBenfc" ControlToValidate="KnListRealBenef" InitialValue="0" ErrorMessage="Real Beneficiery of A/C is Required" runat="server" Display="Dynamic"  ForeColor="Red" Font-Bold="true" ValidationGroup="KnValidationGroup" ></asp:RequiredFieldValidator>
                        ...
                        <div class="form-group">
                            <label class="lblReview">CNIC (If Other):</label>
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator  ID="RequiredFieldValidatorKnRelationAccountHolder" ControlToValidate="KnListRelationAccountHolder" InitialValue="0" ErrorMessage="Relationship with A/C Holder is Required" runat="server" Display="Dynamic"  ForeColor="Red" Font-Bold="true" ValidationGroup="KnValidationGroup" ></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group">
                    ...
                    <div id="sectiong" class="tab-pane fade">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls"> 
                            <asp:RadioButton ID="AutoRollExpiryRadio1" Style="margin-right: 15px" Text="Yes" Checked="True" GroupName="AutoRollExpiryRadioGroup" runat="server" />
                            <asp:RadioButton ID="AutoRollExpiryRadio2" Text="No" GroupName="AutoRollExpiryRadioGroup" runat="server" />
                            </div>
                        </div>
                        <div class="form-group">
